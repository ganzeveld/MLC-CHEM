...
g95 -cpp -O0 -c -ftrace=full -fbounds-check solve_tridiag.f90

echo LINKING...
g95 -cpp -O0 messy_emdep_emis.o messy_emdep_emis_mem.o messy_emdep.o messy_emdep_mem.o messy_emdep_xtsurf_box.o messy_emdep_xtsurf.o messy_main_constants_mem.o messy_main_tools.o solve_tridiag.o -o ../emdep_xtsurf.exe
