...
! This module provides all variables for the EMDEP EMIS submodel
  ...
  REAL, DIMENSION(ncl_yl95) :: &
       noemfact_wet = (/0.,0.,0.,0.,0.05,0.36,0.17,0.03,0.03,0.06,2.6,0.36/)  ! MAQ_lg_20210329+ initialized the basal agricultural emission factor

  ! mz_LG_20020115 emission factor for the twelve ecosystems, dry conditions

  REAL, DIMENSION(ncl_yl95) :: &
       noemfact_dry = (/0.,0.,0.,0.,0.37,2.65,1.44,0.22,0.22,0.40,8.6,0.36/)  ! MAQ_lg_20210329+ initialized the basal agricultural emission factor
